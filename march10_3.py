...
def main():
    ...
    axs[0, 0].set_title('Range Prediction vs. Range Measurement')
    axs[0, 0].legend()
    #axs[0, 0].set_facecolor('#FFEEEE')  # Set background color to pink
    ...
    axs[0, 1].set_title('Azimuth Prediction vs. Azimuth Measurement')
    axs[0, 1].legend()
    #axs[0, 1].set_facecolor('#FFEEEE')  # Set background color to pink
    ...
    axs[1, 0].set_title('Elevation Prediction vs. Elevation Measurement')
    axs[1, 0].legend()
    #axs[1, 0].set_facecolor('#FFEEEE')  # Set background color to pink
    ...
    axs[1, 1].set_title('Time Prediction vs. Time Measurement')
    axs[1, 1].legend()
    #axs[1, 1].set_facecolor('#FFEEEE')  # Set background color to pink
