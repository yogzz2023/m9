...
def main():
    ...
    axs[0, 0].scatter(time, measurements[:, 0], label='Measured Range', marker='.')
    axs[0, 0].plot(time, predicted_ranges, label='Predicted Range', linestyle='-')
    ...
    axs[0, 1].scatter(time, measurements[:, 1], label='Measured Azimuth', marker='.')
    axs[0, 1].plot(time, predicted_azimuths, label='Predicted Azimuth', linestyle='-')
    ...
    axs[1, 0].scatter(time, measurements[:, 2], label='Measured Elevation', marker='.')
    axs[1, 0].plot(time, predicted_elevations, label='Predicted Elevation', linestyle='-')
    ...
    axs[1, 1].scatter(time, measurements[:, 3], label='Measured Time', marker='.')
    axs[1, 1].plot(time, predicted_times, label='Predicted Time', linestyle='-')
